...
# Plot all months
#try a month from a year
ggplot(subset(msagel, month == 6), aes(as.Date(date), str, col=run))+geom_line()+theme(legend.position = "none") +
  geom_line(data=subset(msage, month == 6), aes(as.Date(date), obs), linewidth=2, col="black", linetype=2)+labs(y="Streamflow", x="Date")
```
