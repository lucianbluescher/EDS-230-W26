...
result <- diff1(initialC = 100, # Initial condition
                nx = 10,   # number of space steps
                dx = 0.5,  # distance of space steps
                nt = 10,   # number of time steps
                dt = 10,   # distance of time steps
                D = 0.5,   # Diffusion
...
plot(resfast_fixtime$conc[, 3], 
     ylab = "Concentration for a location 2 spatial units from origin (1+2")
